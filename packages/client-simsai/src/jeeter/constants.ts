...
export const MIN_INTERVAL = Number.parseInt(process.env.MIN_INTERVAL || "120000", 10); // Default: 2 minutes
export const MAX_INTERVAL = Number.parseInt(process.env.MAX_INTERVAL || "300000", 10); // Default: 5 minutes
